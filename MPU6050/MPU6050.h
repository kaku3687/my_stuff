...
public:
    MPU6050();
    virtual int MPU_write(int start, const uint8_t *pData, int size);
    virtual int MPU_write_reg(int reg, uint8_t data);
    virtual int MPU_read(int start, uint8_t *buffer, int size);
};
