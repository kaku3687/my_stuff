...
// Natasha's front four legs:
const unsigned int BASE_I2C_ADDRESS {0x11};
// Natasha's back two legs:
// const unsigned int BASE_I2C_ADDRESS {0x15};
// Sonny's addresses:
// const unsigned int BASE_I2C_ADDRESS  0x28
// const unsigned int BASE_I2C_ADDRESS 0x2C
